...
- Add theme support and remove all Node/Gulp traces (ca79391)
- Add theme support and remove all Node/Gulp traces (#112) (4d1f9f3)
- Add date links into footer, remove 'Posted On' (b1847ad)
- Add date links into footer, remove 'Posted On' (#115) (18cf7da)
- Add branch protection to release branches (b5ce137)
- Add tests to sitemap and fix logic (2e014ed)
- Add openapi spec and update README file (2707bdc)
- Add OpenAPI validation test (188ceb5)
- Add random article link and API call (bcec0d4)
- Add random article link and API call (#127) (e2695d4)
- Add basic stats web page and tests (0d53789)
- Add API endpoint for stats (165691a)
- Add visits table (2acbefe)
- Add visits into stats page and API (f46c71c)
- Add basic SSL support (5122f61)
- Add basic HSTS support (d829cee)
- Add XSS and CSP headers (151e7c7)
- Add relevant tests for additional headers (ac1cfc3)
- Add HTTP2 and Native SSL Support (#134) (4b5c3df)
- Add configurable session and cookie settings (df822a9)
- Add support for .env files (bc26511)
- Add support for .env files (#139) (d6c773e)
- Add timestamps for created and updated and track these in view page and API (54d14ea)
- Add timestamps for created and updated and track these in view page and API (#141) (cc12dbd)
- Added guides for installing and using the journal (953394a)

### Changed

- Update workflow to only run on PR (9baa8af)
- Update to supported version of GitHub upload artifact action (a392e1f)
- Update index and view logic and JSON responses (d1265df)
- Update edit and new logic, extracting session methods (ec46a8f)
- Update SQLite driver to remove CGO and update to go 1.23 (d80c1b0)
- Update SQLite driver to remove CGO and update to go 1.23 (#133) (9200304)
- switch out default config names and articles/posts (30e1097)
- Switch out default config names and articles/posts (#145) (7c55824)
- Refactor folders (#146) (b878ba9)
- improve test coverage (ef0b1c3)

### Fixed

- Fix all current tests (6228d8e)
- Fix API Logic and Refactor Controllers (#123) (cb67567)
- Fix API call to match others (bcd0400)
- Fix API inconsistencies and session decrypt issue (aa97f61)
- Fix API inconsistencies and session decrypt issue (#142) (6de0c97)
- fix: refactor folders to be the same as other go projects (0384d03)
- fix: spaces, not tabs (92ba084)
- fix: spaces, not tabs (#147) (27195e9)

### Other

- Rename milestone (a757097)
- Better pagination support for > 9 pages at once (8f5c0f6)
- Better pagination support for > 9 pages at once (#114) (33c37e5)
- Remove giphy adapter and all usages (e98836c)
- Remove giphy adapter and all usages (#116) (a50e535)
- Release wildcard verification will not work (3c68a13)
- Merge branch 'main' into release/1.0.0 (8b79de9)
- Make static and theme folders configurable (747d3aa)
- Make static and theme folders configurable (#117) (17681f6)
- Form data is now preserved when an error occurs (cc23743)
- Form data is now preserved when an error occurs (#118) (8e5563f)
- Initial audit to get things baselined between devices (03106d6)
- Simplify and standardise fonts on devices (3efad9f)
- Theme audit to standardise fonts and spacing between devices (#119) (e2dc845)
- Migrate content from HTML to Markdown (9561fbd)
- Migrate from HTML to Markdown for content (#126) (53fab27)
- Use the existing spec and tidy up some files (1c2b74b)
- Rename migrations table to be singular, same as journal (580bd3c)
- Enable visit and API tracking (8af086a)
- Stats page (#132) (43713ed)
- Remove CGO from Makefile (31b3512)
- Force HTTP/2 to be available (8f8f249)
- [WIP] Calendar (8e8c936)
- [WIP] Calendar functionality (2146551)
- Calendar tests and fixes for bad requests and container issues (79e306c)
- Calendar (#136) (a1a2fae)
- Configurable excerpt through environment variables for index page (f25ee52)
- Configurable excerpt through environment variables for index page (#137) (bad695a)
- Session cookie config (#138) (95dd363)
- Ensure migration creates the new created_at/updated_at fields (41533a9)
- Ensure migrations run as part of the full end-to-end testing (70b9539)
- remove lambda mentions and build checks (9935a37)
- remove lambda mentions and build checks (#148) (1acd2a1)
- Consolidate and improve styling by simplifying and making the calendar more in-line with other aspects (2b68e1d)
- extract bootstrap into a separate testable piece of code (e9005c4)
- ensure all files are spaced not tabbed (1028ce6)
